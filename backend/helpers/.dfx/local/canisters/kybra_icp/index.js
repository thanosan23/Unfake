...
import { idlFactory } from './kybra_icp.did.js';
export { idlFactory } from './kybra_icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KYBRA_ICP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kybra_icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kybra_icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kybra_icp.did.js")._SERVICE>}
 */
export const kybra_icp = createActor(canisterId);
